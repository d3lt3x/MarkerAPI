...
public class AreaMarker {
    ...
    public AreaMarker(World world, Color color, BlockData markerBlock, BoundingBox actualBox, BoundingBox markerBox, RGBController rgbController) {
        this.world = world;
        this.color = color;
    ...
    public AreaMarker markArea(Area area) {
        ...
        switch (area) {
            case FULL -> {
                this.spawnDisplay(this.scale(new Vector3f((float) this.markerBox.getWidthX(), (float) this.markerBox.getHeight(), 0)), loc1);
                this.spawnDisplay(this.scale(new Vector3f(0, (float) this.markerBox.getHeight(), (float) this.markerBox.getWidthZ())), loc1);
                this.spawnDisplay(this.scale(new Vector3f((float) this.markerBox.getWidthX(), 0, (float) this.markerBox.getWidthZ())), loc1);

                this.spawnDisplay(this.scale(new Vector3f((float) -this.markerBox.getWidthX(), (float) -this.markerBox.getHeight(), 0)), loc2);
                this.spawnDisplay(this.scale(new Vector3f(0, (float) -this.markerBox.getHeight(), (float) -this.markerBox.getWidthZ())), loc2);
                this.spawnDisplay(this.scale(new Vector3f((float) -this.markerBox.getWidthX(), 0, (float) -this.markerBox.getWidthZ())), loc2);
            }

            case NEGATIVE_Z -> this.spawnDisplay(this.scale(new Vector3f((float) this.markerBox.getWidthX(), (float) this.markerBox.getHeight(), 0)), loc1);
            case NEGATIVE_X -> this.spawnDisplay(this.scale(new Vector3f(0, (float) this.markerBox.getHeight(), (float) this.markerBox.getWidthZ())), loc1);
            case BOTTOM -> this.spawnDisplay(this.scale(new Vector3f((float) this.markerBox.getWidthX(), 0, (float) this.markerBox.getWidthZ())), loc1);
            case POSITIVE_Z -> this.spawnDisplay(this.scale(new Vector3f((float) -this.markerBox.getWidthX(), (float) -this.markerBox.getHeight(), 0)), loc2);
            case POSITIVE_X -> this.spawnDisplay(this.scale(new Vector3f(0, (float) -this.markerBox.getHeight(), (float) -this.markerBox.getWidthZ())), loc2);
            case TOP -> this.spawnDisplay(this.scale(new Vector3f((float) -this.markerBox.getWidthX(), 0, (float) -this.markerBox.getWidthZ())), loc2);
        }
    ...
    private void spawnDisplay(Transformation transformation, Location location) {
        ...
        this.world.spawn(location, BlockDisplay.class, blockDisplay -> {
